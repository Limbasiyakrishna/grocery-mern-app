...
import ManageBlogs from "./pages/seller/ManageBlogs";
import AddBlog from "./pages/seller/AddBlog";
      ...
      <div className={`${isSellerPath ? "" : "px-3 sm:px-6 md:px-10 lg:px-16 xl:px-24"}`}>
        <Routes>
          ...
          >
            ...
            <Route path="blogs" element={isSeller ? <ManageBlogs /> : null} />
            <Route path="add-blog" element={isSeller ? <AddBlog /> : null} />
            <Route path="edit-blog/:id" element={isSeller ? <AddBlog /> : null} />
          </Route>
        </Routes>
      </div>
